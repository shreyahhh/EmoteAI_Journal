...
const AuthPage = ({ isLogin, navigateTo }) => {
  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden bg-emote-canvas font-sans text-emote-body text-emote-ink">
      ...
      <section className="relative z-10 px-6 pb-16 pt-6">
        <div className="container mx-auto grid max-w-5xl items-start gap-10 lg:grid-cols-2 lg:gap-12">
          <div className="text-center lg:text-left">
            <h2 className="text-emote-display font-semibold tracking-tight text-emote-ink md:text-emote-display-lg">
              Journal with <span className="emote-title-gradient">AI insight</span>
            </h2>
            <p className="mt-3 max-w-md text-emote-muted leading-relaxed text-emote-ink-soft lg:max-w-none">
          ...
          <div className="mx-auto w-full max-w-md lg:mx-0 lg:ml-auto">
            <div className="auth-card-emote">
              <h1 className="text-center text-emote-section font-semibold text-emote-ink">
              ...
              <form onSubmit={handleSubmit} className="relative z-10 space-y-5">
                <div>
                  <label htmlFor="email" className="mb-1.5 block text-emote-caption font-medium uppercase tracking-wide text-emote-ink-faint">
                    Email
                  </label>
                  <input
                    type="email"
                ...
                <div>
                  <label htmlFor="password" className="mb-1.5 block text-emote-caption font-medium uppercase tracking-wide text-emote-ink-faint">
                    Password
                  </label>
                  <input
                    type="password"
              ...
              <p className="relative z-10 mt-6 text-center text-emote-muted text-emote-ink-soft">
      ...
      <footer className="relative z-10 border-t border-emote-border px-6 py-8">
        <p className="text-center text-emote-muted text-emote-ink-soft">&copy; {new Date().getFullYear()} Emote</p>
      </footer>
    </div>
  );
};
