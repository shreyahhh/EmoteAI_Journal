  ...
  return (
    <>
      ...
      <div className="emote-banner-warn mb-8" role="alert">
        <strong className="font-semibold text-rose-900">Crisis support: </strong>
        <span className="text-rose-900/95">
      ...
      <p className="mb-6 mt-1.5 max-w-2xl text-emote-muted leading-relaxed text-slate-500">
